...
<?php echo $this->Form->create('Child');?>
    ...
    <div id="similarChildrenBox">
        <div id="similarChildrenLoader">
            <?php echo $this->Html->image('ajax-loader.gif', array('class' => 'loader')); ?>
            Пошук схожих записів...
        </div>
        <div id="similarChildrenInsertPlace"></div>
    </div>

<div class="submit" id="submit_div">
    <?php echo $form->submit('Зберегти', array('class' => 'input-submit', 'id' => 'childSubmit', 'div' => false)); ?> або 
    <?php echo $form->button('Відмінити', array('class' => '', 'id' => 'cancelAddingChildButton', 'div' => false, 'onclick' => 'backToChildrenList();', 'type' => 'button')); ?>
</div>
